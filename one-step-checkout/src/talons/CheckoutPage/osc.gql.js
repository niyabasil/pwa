...
export const GET_ZIP_PAYMENT_REQUEST_DATA = gql`
    query getZipPaymentRequestData($cart_id: String!) {
        zippaymentPaymentUrl(cart_id: $cart_id) {
            payment_link
        }
    }
`;
...
export default {
    ...
    getZippaymentUrl: GET_ZIP_PAYMENT_REQUEST_DATA
};
