...
namespace Tigren\Pwa\Override\Magento\Sales\Model\Reorder;
...
class Reorder extends \Magento\Sales\Model\Reorder\Reorder
{
    ...
    public function __construct(
        ...
        parent::__construct($orderFactory, $customerCartProvider, $guestCartResolver, $cartRepository, $reorderHelper,
            $logger, $productCollectionFactory, $orderInfoBuyRequestGetter);
