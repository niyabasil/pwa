...
/**
 * Class Categories
 * @package Tigren\Pwa\Override\Magento\CatalogGraphQl\Model\Resolver\Categories
 */
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null)
    {
        ...
        return $this->valueFactory->create(
            function () use ($that, $categoryIds, $info) {
                ...
                // Add is active filter to category collection
                if (!$this->collection->isLoaded()) {
                    $that->attributesJoiner->join($info->fieldNodes[0], $this->collection, $info);
                    $this->collection->addIdFilter($this->categoryIds)->addIsActiveFilter();
                }
