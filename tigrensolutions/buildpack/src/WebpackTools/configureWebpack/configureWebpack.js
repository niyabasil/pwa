...
const MagentoResolver = require('@magento/pwa-buildpack/lib/WebpackTools/MagentoResolver');
const BuildBus = require('@magento/pwa-buildpack/lib/BuildBus/BuildBus');
const BuildBusPlugin = require('@magento/pwa-buildpack/lib/WebpackTools/plugins/BuildBusPlugin');
...
async function configureWebpack(options) {
    const { context, extendPaths = [] } = options;
