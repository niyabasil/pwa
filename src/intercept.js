...
module.exports = targets => {
    ...
    targets.of("@magento/venia-ui").routes.tap((routes) => {
      routes.push({
        ...
        pattern: "/ewayrapid/redirect/success",
        path: require.resolve(
          "@eway/eway/src/components/eway/",
        ),
      });
      return routes;
    });
    ...
    // targets.of("@magento/venia-ui").routes.tap((routes) => {
    //   routes.push({
    //     name: "Eway Success Page",
    //     pattern: "/checkout/eway/success",
    //     path: require.resolve(
    //       "@eway/eway/src/components/ewaysuccess/",
    //     ),
    //   });
    //   return routes;
    // });
    ...
    //         '@eway/eway/src/plugins/checkoutPageTalonPlugin'
    //     );
    // });
};
